...
#---------------------------------------------------------
 ...
 set target_library NangateOpenCellLibrary_fast_ccs.db
 set link_library   NangateOpenCellLibrary_fast_ccs.db
...
#---------------------------------------------------------
 ...
 set link_library   NangateOpenCellLibrary_slow_ccs.db
 set link_library   [concat  $link_library dw_foundation.sldb]
 translate
